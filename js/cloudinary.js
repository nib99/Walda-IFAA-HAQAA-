 ...
 * which must never live in frontend code. This dashboard marks assets as
 * removed in Firestore immediately; to also purge the file from Cloudinary
 * storage, wire this UI to a small server-side/Cloud Function endpoint that
 * holds your API secret and calls the Admin API's `destroy` method.
 */
